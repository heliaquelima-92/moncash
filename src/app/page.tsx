...
export default function Home() {
  // SUBSTITUA O LINK ABAIXO PELO LINK DA LOGO QUE VOCÊ ME MANDOU
  const logoUrl = "LINK_DA_SUA_LOGO_AQUI"; 
    ...
    <div className="flex min-h-screen bg-[#111111] text-white font-sans">
      ...
      <aside className="w-64 border-r border-[#D5FF40]/20 p-6 flex flex-col gap-8">
        ...
        <nav className="flex flex-col gap-4">
          <a href="#" className="flex items-center gap-3 text-[#D5FF40] bg-[#D5FF40]/10 p-3 rounded-lg">
      ...
      <main className="flex-1 p-10">
        <header className="flex justify-between items-center mb-10">
          ...
          <button className="bg-[#D5FF40] text-black px-6 py-3 rounded-full font-bold flex items-center gap-2 hover:brightness-90 transition-all">
        ...
        <div className="grid grid-cols-3 gap-6 mb-10">
          <div className="bg-[#1a1a1a] p-6 rounded-2xl border border-[#D5FF40]/30">
          ...
          <div className="bg-[#1a1a1a] p-6 rounded-2xl border border-white/10">
            <div className="flex items-center gap-2 text-green-400 mb-2">
              <ArrowUpCircle size={18} /> <span>Entradas</span>
            </div>
            <h2 className="text-3xl font-bold">R$ 0,00</h2>
          </div>
          <div className="bg-[#1a1a1a] p-6 rounded-2xl border border-white/10">
            <div className="flex items-center gap-2 text-red-400 mb-2">
              <ArrowDownCircle size={18} /> <span>Saídas</span>
            </div>
            <h2 className="text-3xl font-bold">R$ 0,00</h2>
          </div>
        </div>
        ...
        <div className="bg-[#1a1a1a] rounded-2xl p-6 border border-white/5">
          ...
          <div className="text-center py-10 text-gray-500">
            <p>Nenhuma transação encontrada no Supabase.</p>
          </div>
        </div>
      </main>
    </div>
