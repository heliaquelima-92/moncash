...
export default function BillForm({ bill, onSubmit, onClose }) {
  ...
  function handleSubmit(event) {
    ...
    const installmentDescription = form.installmentDescription.trim();
    const name = form.isInstallment ? typedName || installmentDescription : typedName;
    const description = installmentDescription || typedName;
    if (!name) return;
